...
namespace TSPCsharp
{
    class TSP
    {
        ...
        static void PercLoop(double perc)
        {
        ...
        static void HLoop(double perc, int numb)
        {
            cplex.SetParam(Cplex.DoubleParam.EpGap, perc);
        ...
        static void CommonInit(int numb)
        {
            z = BuildModel(numb);
